...
{block name='main'}
    ...
    <div id="api_link" class="api_wrapper" style="margin-top:1rem; text-align:center;">
        <a href="https://rapidapi.com/ahmedyad200/api/youtube-to-telegram-uploader-api" target="_blank">
            <img src="https://rapidapi.com/ahmedyad200/api/youtube-to-telegram-uploader-api/logo.png"
                 alt="YouTube to Telegram Uploader API" class="apiLogo" style="max-width:200px; height:auto;"/>
        </a>
    </div>
{/block}
